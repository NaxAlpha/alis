...
# Let's add the ability to overwrite fmaps
@click.option('--g_fmaps', help='Multiplier for the channel_base for G', type=float, metavar='FLOAT')
@click.option('--d_fmaps', help='Multiplier for the channel_base for D', type=float, metavar='FLOAT')

# Dimensionalities for the mapping network in G
@click.option('--z_dim', help='Input noise dimensionality', type=int, metavar='INT')
@click.option('--w_dim', help='Style dim dimensionality', type=int, metavar='INT')

@click.option('--hydra_cfg_name', help='Name of the hydra config', type=str, metavar='STR')
